...
public class GoodGuyRadar : Sense
{
    [SerializeField]
    ...
    {
        badGuysLocation.Where(badGuysLocation => Vector3.Distance(badGuysLocation.transform.position, DetectionCenterPos) <= detectionRange).ToList();
